...
#AutoIt3Wrapper_outfile=Smart_Driver_V2.0.exe
#AutoIt3Wrapper_Compression=4
#AutoIt3Wrapper_Res_Comment=Smart_Driver
#AutoIt3Wrapper_Res_Description=Smart_Driver
#AutoIt3Wrapper_Res_Fileversion=2.0.0.0
#AutoIt3Wrapper_Res_LegalCopyright=Smart_Driver_V2.0
...
$Form1 = GUICreate("Smart_Driver_V2.0", 496, 380, -1, -1)
$TreeView1 = GUICtrlCreateTreeView(4, 4, 153, 289,BitOR($TVS_EDITLABELS, _
...
Func begin_time();定义倒计时函数
	...
	If $time <= 0 Then ControlClick("Smart_Driver_V2.0","",$Button1,"left",1)
EndFunc
